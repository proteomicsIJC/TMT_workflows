...
### Get the data----
maxquant <- read.table("./raw_data/Phospho_maxquant.txt", header = T, check.names = F, sep = "\t", dec = ".")
...
# The data was previously cleaned, co maxquant_clean = maxquant
maxquant_clean <- maxquant
...
# Annotation
annotation <- subset(maxquant_clean, select = c(protein_group,protein,positions_within_proteins,gene_names,
                                                fasta_headers,localization_prob,amino_acid,position_in_peptide,pep,
                                                score,sequence_window,phospho_sty_probabilities,multiplicity))
...
tt <- relocate(.data = tt, c("protein","positions_within_proteins","gene_names",
                             "fasta_headers","localization_prob","amino_acid","position_in_peptide","pep",
                             "score","sequence_window","phospho_sty_probabilities","multiplicity"), .after = "protein_group")
